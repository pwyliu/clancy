...
You can set a default for any optional command line argument. Typically you will just want to set `--server` and `--cacert` but you can also set a default for `--user` if your Red October username is not the same as your shell username.
